...
//                                                 console.log("Params envoyés à make_bid :");
//                                                 console.log("auc_id:", auc_id);
//                                                 console.log("ordervals:", ordervals);
//                                                 console.log("biddedvals (wei):", biddedvals);
//                                                 console.log("from:", account_addr);
...
//                                             if (!amount || parseFloat(amount) <= parseFloat(this.state.product.price)) {
//                                             this.setState({ auction_bid_modal: true });
//                                             return;
//                                             }

//                                             if (this.state.account_bal < parseFloat(amount) + 0.01) { // marge pour le gas
//                                             this.setState({ balance_modal: true });
//                                             return;
//                                             }
...
//                                             const auc_id = this.state.product._id;

//                                             const order = (this.state.product.bid_count || 0) + 1;
//                                             const biddedValueWei = web3.utils.toWei(amount.toString(), 'ether');

//                                             console.log("Params make_bid :", {
//                                                 auction_id: auc_id,
//                                                 order: order,
//                                                 valueWei: biddedValueWei,
//                                                 from: account_addr,
//                                             });

//                                             // Estimation du gaz (très utile pour debug)
//                                             await contract.methods
//                                                 .make_bid(auc_id, order, biddedValueWei)
...
//                                                 // ... ton code de refresh tablearr ...
//                                                 })
//                                                 .on('error', (error) => {
//                                                 console.error("Erreur transaction:", error);
//                                                 alert("Échec de l'enchère : " + (error.message || "Transaction rejetée"));
//                                                 });
//                                             } catch (err) {
//                                             console.error("Erreur préparation/envoi:", err);
//                                             alert("Échec simulation : " + (err.reason || err.message || "Rejet par le contrat"));
//                                             }
//                                         }}
//                                         >
//                                         Make a Bid
...
class MakeBid extends Component {
    ...
    async componentDidMount() {
        ...
        if (res) {
            ...
            const auc_id = res.blockchain_id; // ← CHANGEMENT IMPORTANT
            const contract = this.state.contractval;
        ...
        socket.on('message', data => {
            ...
            const prod_id = this.state.product.blockchain_id; // ← CHANGEMENT IMPORTANT
            if (data["id"] === prod_id) {
